...
public:
        ...
        :sprite(idletex[0]),firesprite(idletex[0]),clothsprit(clothtex[0]),sound(sound),sound2(sound2),world(world)
    {
        ...
        const std::string attack[8] = { "resources/��1.png","resources/��2.png", "resources/��3.png","resources/��4.png", "resources/��5.png", "resources/��6.png","resources/��6.png" ,"resources/��6.png" };
